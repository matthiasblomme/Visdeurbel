...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.llava_next.modeling_llava_next import (np, torch, nn, init, ACT2FN, Cache, GenerationMixin, select_best_resolution, ModelOutput, BaseModelOutputWithPooling, PreTrainedModel, Unpack, TransformersKwargs, can_return_tuple, LlavaNextConfig, logger, __name__, LlavaNextModel, LlavaNextCausalLMOutputWithPast, LlavaNextPreTrainedModel, LlavaNextForConditionalGeneration)
...
def LlavaNextMultiModalProjector_forward(self, image_features):
...
class LlavaNextMultiModalProjector(nn.Module):
    ...
    def forward(self, image_features):
        return LlavaNextMultiModalProjector_forward(self, image_features=image_features)


@torch.compiler.disable(recursive = False)
@can_return_tuple
def LlavaNextForConditionalGeneration_forward(
    self,
