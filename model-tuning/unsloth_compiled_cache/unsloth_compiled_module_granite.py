...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.granite.modeling_granite import (Callable, Optional, torch, nn, ACT2FN, Cache, GenerationMixin, use_kernel_func_from_hub, BaseModelOutputWithPast, CausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, TransformersKwargs, can_return_tuple, maybe_autocast, GraniteConfig, logger, __name__, GranitePreTrainedModel, GraniteModel, GraniteForCausalLM)
...
class GraniteAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return GraniteAttention_forward(self, hidden_states=hidden_states, position_embeddings=position_embeddings, attention_mask=attention_mask, past_key_values=past_key_values, cache_position=cache_position, **kwargs)
